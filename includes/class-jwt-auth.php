...
class Jwtauth
{
     ...
     * @since    1.0.0
     *
     * @var Jwtauth_Loader Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - Jwtauth_Loader. Orchestrates the hooks of the plugin.
     * - Jwtauth_i18n. Defines internationalization functionality.
     * - Jwtauth_Admin. Defines all hooks for the admin area.
     * - Jwtauth_Public. Defines all hooks for the public side of the site.
     *
    ...
    private function load_dependencies()
    {
        ...
        $this->loader = new Jwtauth_Loader();
    }

    /**
     * Define the locale for this plugin for internationalization.
     *
     * Uses the Jwtauth_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     */
    ...
    {
        $plugin_public = new Jwtauth_Public($this->get_plugin_name(), $this->get_version());
     ...
     * @since     1.0.0
     *
     * @return Jwtauth_Loader Orchestrates the hooks of the plugin.
     */
